...
$sql="SELECT * FROM loans_payment join users on loans_payment.user_id = users.id";
...
////            <td>ksh.' . $row['loan_type'] . '</td>
////            <td>ksh.' . $row['date_borrowed'] . '</td>
////            <td>ksh.' . $row['due_date'] . '</td>
////            <td>ksh.' . $row['interest'] . '</td>
////            <td>ksh.' . $row['transaction_cost'] . '</td>
