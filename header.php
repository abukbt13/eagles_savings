...
<div class="head   mx-2 d-md-flex d-lg-flex  justify-content-between align-items-center  bg-light">
    <a class="text-decoration-none d-flex align-items-center justify-content-between text-uppercase" style="font-size: 18px;">
        <p style="font-size: 24px;padding-top: 0.7rem">Eagles Savings</p>
